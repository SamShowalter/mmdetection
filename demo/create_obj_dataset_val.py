...
if __name__ in '__main__':
    with open("../../Scene_Graph_Novelty/data/coco/clean/ms_coco_val2017_filename_ordering.pkl", 'rb') as file:
        paths = pkl.load(file)
    ...
    i = 0
    for p in paths:
        img_path = "../../Scene_Graph_Novelty/data/coco/images/val2017/{}"\
        .format(p)
    ...
    torch.save(bboxes, '../../Scene_Graph_Novelty/data/coco/extracted/ms_coco_val2017_bboxes_top50.pt')
    torch.save(labels, '../../Scene_Graph_Novelty/data/coco/extracted/ms_coco_val2017_labels_top50.pt')
    torch.save(probs, '../../Scene_Graph_Novelty/data/coco/extracted/ms_coco_val2017_probs_top50.pt')
